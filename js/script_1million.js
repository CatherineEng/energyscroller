...
var KWH_PER_PIXEL = 10000;    // 10 px tick = 1,000,000 kWh => 1 px = 100,000 kWh
var TICK_KWH = 100000;        // one tick in kWh
...
// ---- SHOW COUNTER AFTER ONE TICK (1,000,000 kWh) ----
...
function setHeight() {
  ...
  var height = Math.ceil(TOTAL_KWH / KWH_PER_PIXEL); // ~111,507 px
  kwh.style.height = height + "px";

  if (!mute && thousand) {
    // #thousand shows ONE TICK height (1,000,000 kWh = 10 px)
